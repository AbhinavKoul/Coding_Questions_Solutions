...
#include<algorithm>
using namespace std;
//goto interviewbit -> maths -> Nmbers of lenth B less than equal to K
...
/*
A = SET of digits which we can use
C = limit number
eg.
A = {0,1,2,3,4}
C = 432

_ * _ * _ --> all numbers <432 we need to find(count only)
*/
int numberOfWaysNumberLessThanC(vector<int> &A, int C)
{
...
int main()
{
    ...
    cout<<"hello : "<<numberOfWaysNumberLessThanC(arr,454);
}